                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="topbar-text">
                            <ul class="list-inline text-right">
                                <li class="list-inline-item"><router-link to="/login" ><span class="fas fa-user mr-2"></span> Login</router-link></li>
                                <li class="list-inline-item"><router-link to="/register" ><span class="fas fa-lock mr-2"></span> Register</router-link>
                                </li>
                            </ul>
                        </div>
                    </div>
